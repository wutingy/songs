...
export const ALBUMS: Album[] = [
  {
    slug: 'songs-of-leonard-cohen',
    title: 'Songs of Leonard Cohen',
    artist: 'Leonard Cohen',
    year: 1967,
    color: '#5b6a78',
    coverImage: cohenCover,
    songs: [
      {
        slug: 'suzanne',
        title: 'Suzanne',
...
因為她已用她的心靈觸碰了你完美的軀體。`,
      },
      {
        ...
        title: 'Master Song',
        titleZh: '大師之歌',
        lyrics: `I believe that you heard your master sing
我相信你聽見了你的大師在歌唱
...
你的囚徒美酒與麵包嗎？`,
      },
      {
        ...
        title: 'Winter Lady',
        titleZh: '冬日女士',
        lyrics: `Trav'ling lady, stay awhile
旅行的女士，請留步片刻
...
我知道我不是你的愛人。`,
      },
      {
        ...
        titleZh: '陌生人之歌',
        lyrics: `It's true that all the men you knew were dealers
確實，你認識的所有男人都是毒販
...
我來的時候就告訴過你我是個陌生人。`,
      ...
      {
        slug: 'sisters-of-mercy',
        title: 'Sisters of Mercy',
        titleZh: '仁慈姐妹',
        lyrics: `Oh the sisters of mercy, they are not departed or gone.
噢，那些仁慈姐妹，她們並未離開或消失。
...
我們並不是那樣的戀人，況且那樣也無妨。`,
      ...
      {
        slug: 'so-long-marianne',
        title: 'So Long, Marianne',
        titleZh: '再見，瑪麗安',
        lyrics: `Come over to the window, my little darling,
過來窗邊，我的小寶貝，
...
噢，再見了，瑪麗安，是時候讓我們開始……`,
      ...
      {
        slug: 'hey-thats-no-way-to-say-goodbye',
        title: "Hey, That's No Way To Say Goodbye",
        titleZh: '嘿，那不是告別的方式',
        lyrics: `I loved you in the morning, our kisses deep and warm,
我在清晨愛著你，我們的吻深沉而溫暖，
...
嘿，那不是告別的方式。`,
      ...
      {
        slug: 'stories-of-the-street',
        title: 'Stories of the Street',
        titleZh: '街道的故事',
        lyrics: `The stories of the street are mine, the Spanish voices laugh.
街道的故事屬於我，西班牙裔的聲音在笑。
...
迷失在地下鐵的人群中，我試著吸引你的目光。`,
      },
      {
        slug: 'teachers',
        title: 'Teachers',
        titleZh: '老師',
        lyrics: `I met a woman long ago
很久以前我遇到一個女人
...
「你的課程結束了嗎？」`,
      ...
      {
        slug: 'one-of-us-cannot-be-wrong',
        title: 'One Of Us Cannot Be Wrong',
        titleZh: '我們之中有一個不可能錯',
        lyrics: `I lit a thin green candle, to make you jealous of me.
我點燃一根細長的綠蠟燭，想讓你嫉妒我。
